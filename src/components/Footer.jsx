            ...
            <Container>
                ...
                <Row className="pt-2 pl-4">
                    <ul className="col-2 list-unstyled">
                        ...
                        <li > <a href="" className="footer_link">Privacy & Terms</a></li>
                        <li > <a href="" className="footer_link">Sales Solutions</a></li>
                        <li ><a href="" className="footer_link">Safety Center</a></li>
                    </ul>
                    <ul className="col-2 list-unstyled">
                        <li > <a href="" className="footer_link">Accessibility</a> </li>
                        <li ><a href="" className="footer_link">Careers</a></li>
                        <li > <a href="" className="footer_link">Ad Choices</a></li>
                        <li > <a href="" className="footer_link">Mobile</a></li>
                        
                    </ul>
                    <ul className="col-2 list-unstyled">
                        <li > <a href="" className="footer_link">Talent Solutions</a> </li>
                        <li ><a href="" className="footer_link">Marketing Solutions</a></li>
                        <li > <a href="" className="footer_link">Advertising</a></li>
                        <li > <a href="" className="footer_link">Small bussiness</a></li>
                        
                    </ul>
                    <Col xs={4}>
                        <ul className="list-unstyled">
                            <li ><BsQuestionCircleFill/> <a href="" className="pl-1 footer_link"> Questions?</a> <br /> <span className="footer_label pl-4">Visit our help center</span> </li>
                            <li ><BsFillGearFill/> <a href="" className="pl-1 footer_link"> Manage your account and privacy</a> <br /> <span className="footer_label pl-4">Go to your Settings</span> </li>
